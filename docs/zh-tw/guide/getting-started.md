...
| **隱藏設定** | 靜音、暫停鍵、通知區域圖示、最小化等隱藏時的附加行為 | [隱藏設定](/zh-tw/guide/hiding) |
| **提示設定** | 控制氣泡通知與圖示狀態角標 | [提示設定](/zh-tw/guide/notifications) |
| **關於與意見回饋** | 版本資訊、檢查更新、公告、問題回報 | [檢查更新與意見回饋](/zh-tw/guide/update) |
| **通用設定** | 開機自動啟動、執行權限、介面語言、記錄檔、復原工具 | [通用設定](/zh-tw/guide/options) |
...
::: info 按下通知區域圖示
預設**以左鍵按一下**圖示即可隱藏／顯示視窗。按一下、按兩下、右鍵各綁什麼動作可以自行變更，參閱[通知區域圖示點擊行為](/zh-tw/guide/notifications#通知區域圖示點擊行為)。
:::
